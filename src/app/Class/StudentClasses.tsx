        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 pb-6 mt-4">
          {items.map((cls: ClassItem, index: number) => {
            ...
            return (
              ...
              >
                <Link href={`/Class/${instance?.classSemesterId || cls.classId}?classCode=${encodeURIComponent(idString)}&semesterCode=${encodeURIComponent(semesterCode)}&classId=${cls.classId}`} className="block h-full">
