...
import { useLoginMutation, useGoogleLoginMutation, useGithubLoginMutation } from "@/store/queries/auth";
...
export default function LoginModal() {
  ...
  const [githubLogin, { isLoading: isGithubLoading }] = useGithubLoginMutation();
  ...
  const handleGithubLogin = async () => {
    try {
      const res = await githubLogin({ accessToken: GITHUB_TOKEN }).unwrap();
      ...
      addToast({ title: "GitHub Login Failed", color: "danger" });
    }
  };
