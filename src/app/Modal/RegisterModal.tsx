    ...
    <div className="relative flex flex-col gap-5 py-10 px-8 bg-white dark:bg-[#282E3A] transition-colors duration-500 rounded-[2.5rem] shadow-2xl max-w-[480px] w-full border-none outline-none">
      ...
      <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
        ...
        <Button
          ...
          className="bg-[#3F4755] dark:bg-[#FFB800] text-white dark:text-[#071739] font-black rounded-2xl h-14 mt-4 shadow-lg uppercase tracking-widest text-sm transition-transform active:scale-95"
        >
          Sign up now
        </Button>
      </form>
