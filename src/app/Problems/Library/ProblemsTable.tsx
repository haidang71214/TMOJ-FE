...
export const ProblemsTable = ({ problems, likedProblems, solvedProblems, toggleLike, page = 1, pageSize = 10 }: ProblemsTableProps) => {
          ...
          return (
            ...
            >
              ...
              <TableCell className="text-center py-5">
                <span
                  className={`inline-block text-[12px] font-black px-2 py-1 rounded-md ${p.difficulty?.toLowerCase() === "easy"
              ...
              <TableCell className="py-5 text-center">
                {solvedProblems.has(p.id) ? (
                  ...
                  <span className="text-[10px] text-gray-300 dark:text-[#475569] italic font-black uppercase tracking-widest">—</span>
                )}
              </TableCell>
            </TableRow>
          );
