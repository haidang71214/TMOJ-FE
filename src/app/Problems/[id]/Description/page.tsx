...
import { FileText, Clock, Database, Calendar, CheckCircle2 } from "lucide-react";
    ...
    <div className="h-full overflow-y-auto px-6 py-5 space-y-6 no-scrollbar">
      ...
      <div className="space-y-3">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[11px] font-bold text-gray-400 dark:text-[#667085] bg-gray-100 dark:bg-[#101828] border dark:border-[#334155]">
            <CheckCircle2 size={11} /> {problem.isActive ? "Active" : "Inactive"}
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-gray-50 dark:bg-[#101828] rounded-xl p-5 border dark:border-[#334155]">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-[12px] text-gray-500 dark:text-gray-400">Time Limit</p>
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-[12px] text-gray-500 dark:text-gray-400">Memory Limit</p>
            <p className="text-[14px] font-semibold text-[#262626] dark:text-[#F9FAFB]">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-[12px] text-gray-500 dark:text-gray-400">Created At</p>
            <p className="text-[14px] font-semibold text-[#262626] dark:text-[#F9FAFB]">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-[12px] text-gray-500 dark:text-gray-400">Published At</p>
            <p className="text-[14px] font-semibold text-[#262626] dark:text-[#F9FAFB]">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-[12px] text-gray-500 dark:text-gray-400">Acceptance</p>
            <p className="text-[14px] font-semibold text-[#262626] dark:text-[#F9FAFB]">
