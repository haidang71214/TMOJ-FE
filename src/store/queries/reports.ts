...
export const reportsApi = baseApi.injectEndpoints({
  ...
  endpoints: (builder) => ({
    ...
    approveReport: builder.mutation<{ data: boolean; message: string; traceId: string | null }, { id: string; reason?: string }>({
    ...
    rejectReport: builder.mutation<{ data: boolean; message: string; traceId: string | null }, { id: string; reason?: string }>({
      query: ({ id, reason = null }) => ({
